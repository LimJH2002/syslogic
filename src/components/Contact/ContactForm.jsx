...
export default function ContactForm() {
  ...
  return (
    <div className="isolate bg-white px-6 pt-16 pb-5">
      ...
      >
        <div
          className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ffa500] to-[#ff6a00] opacity-25 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg text-gray-600">
          Reach out to us for collaborations, queries, or assistance.
        </p>
      </div>
      <form
        action="#"
        method="POST"
        className="mx-auto max-w-xl sm:mt-2"
      >
            ...
            <div className="flex h-6 items-center">
              <Switch
                ...
                className={classNames(
                  ...
                  "flex w-8 flex-none cursor-pointer rounded-full p-px ring-1 ring-inset ring-gray-900/5 transition-colors duration-200 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600"
                )}
              >
