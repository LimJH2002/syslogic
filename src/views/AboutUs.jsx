              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  <p className="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                    ...
                    relocation services.
                    <br />
                    At Syslogic, we aim to be your one-stop solution provider
                    for all IT-related services. Our reputation is built on our
                    core values of quality service and competitive pricing. With
                    a team of well-trained staff, we provide value-added and
                    efficient services to all our customers.
                  </p>
                </div>
          ...
          <div className="flex items-center justify-center">
            ...
            <div className="mx-auto max-w-2xl lg:mx-0">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                ...
                success defines who we are and drives everything we do.
              </p>
            </div>
          </div>
